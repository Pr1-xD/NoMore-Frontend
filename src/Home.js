...
function Home(props) {
    return (
        <div>
           <section>
  <div class="relative  w-full px-5 py-12 mx-auto md:px-12 lg:px-16  lg:py-24 bg-image">
    <div class="flex w-full mx-auto text-left ">
      <div class="relative inline-flex items-bottom mx-auto align-bottom">
        <div class="text-center">
          {/* <h1 class="max-w-5xl text-2xl font-bold leading-none tracking-tighter text-neutral-600 md:text-5xl lg:text-6xl lg:max-w-7xl">
            No More FOMO <br class="hidden lg:block"/>
          ...
          <div class="flex  object-bottom w-full max-w-2xl gap-2 mx-auto mt-9">
            <div class="mt-3 rounded-lg sm:mt-0">
              <button class="px-9 py-4 text-4xl text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-main-color lg:px-10 rounded-xl hover:bg-main-color focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Calm Me Now</button>
            </div>
